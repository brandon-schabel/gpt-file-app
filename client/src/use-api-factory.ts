...
interface FetcherState<ResponseType> {
...
type FetcherReturnType<DataType extends FetcherConfig<any, any, any>> = {
...
function createFetcher<DataType extends FetcherConfig<any, any, any>>(
  ...
  const fetchData = useCallback(
    async (
      ...
      try {
        ...
        switch(method) {
          case "get":
            result = await fetchFactory.get(endpointConfig.endpoint as string, endpointConfig.params || params);
            break;
          case "post":
